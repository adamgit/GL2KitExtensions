#import "VideoTextureViewController.h"
...
@implementation VideoTextureViewController
{
...
- (void)captureOutput:(AVCaptureOutput *)captureOutput didOutputSampleBuffer:(CMSampleBufferRef)sampleBuffer fromConnection:(AVCaptureConnection *)connection
{
	...
	CVOpenGLESTextureRef* oldRef = &appleCreatedTexture1;
    // Y-plane
	...
	if( self.textureVideoLuminance == nil )
	{
		...
		//NSLog(@"Creating new luminance texture for video (old = %i, new = %i)...", (self.textureVideoLuminance == nil? -1 :self.textureVideoLuminance.glName), (appleCreatedTexture1 == NULL? -1 :CVOpenGLESTextureGetName(appleCreatedTexture1)));
	...
	else if( self.textureVideoLuminance.glName != CVOpenGLESTextureGetName(appleCreatedTexture1) )
	{
		...
		//NSLog(@"SWAPPING luminance texture ref (old = %i, new = %i)...", (self.textureVideoLuminance == nil? -1 :self.textureVideoLuminance.glName), (appleCreatedTexture1 == NULL? -1 :CVOpenGLESTextureGetName(appleCreatedTexture1)));
	...
	glNameWasCreatedOrChanged = FALSE;
	if( self.textureVideoChroma == nil )
	{
		...
		self.textureVideoChroma.willDeleteOnDealloc = FALSE;
	...
	else if( self.textureVideoChroma.glName != CVOpenGLESTextureGetName(appleCreatedTexture2) )
	{
		glNameWasCreatedOrChanged = TRUE;
		
		//NSLog(@"SWAPPING chroma texture ref (old = %i, new = %i)...", (self.textureVideochroma == nil? -1 :self.textureVideochroma.glName), (appleCreatedTexture2 == NULL? -1 :CVOpenGLESTextureGetName(appleCreatedTexture2)));
		
		[self.textureVideoChroma liveAlterGLNameToWorkaroundAppleCoreVideoBug:CVOpenGLESTextureGetName(appleCreatedTexture2)];
