...
{
	static GLK2HardwareMaximums* internalInstance;
	if( internalInstance == nil )
	{
		internalInstance = [GLK2HardwareMaximums new];
		[internalInstance readAllGLMaximums];
	}
...
- (id)init
{
    self = [super init];
    if (self) {
        self.iOSDeviceRAM = DeviceMemory0Bytes;
    }
    return self;
}
